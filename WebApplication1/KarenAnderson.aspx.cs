...
{
    public partial class KarenAnderson : System.Web.UI.Page
    {
        private string name;
        ...
        {
            Global.MDrespond++;
            Global.KarenAndersonStatus = "Enroute";
            int minutes = Convert.ToInt16(TextBox1.Text);
            DateTime time = DateTime.Now;
            TimeSpan eta = new TimeSpan(0, minutes, 0);
            Global.KarenAnderson = time.Add(eta);
            
        //    Global.KarenAnderson = TextBox1.Text;
