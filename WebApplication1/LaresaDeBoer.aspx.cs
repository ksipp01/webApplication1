...
{
    public partial class LaresaDeBoer : System.Web.UI.Page
    {
        private string name;
        ...
        {
            Global.MDrespond++;
            Global.LaresaDeboerStatus = "Enroute";
            int minutes = Convert.ToInt16(TextBox1.Text);
            DateTime time = DateTime.Now;
            TimeSpan eta = new TimeSpan(0, minutes, 0);
            Global.LaresaDeboer = time.Add(eta);
            //   Global.LaresaDeboer = combined.ToString();
