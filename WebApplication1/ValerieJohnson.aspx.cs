...
{
    public partial class ValerieJohnson : System.Web.UI.Page
    {
        private string name;
        ...
        {
            Global.MDrespond++;
            Global.ValerieJohnsonStatus = "Enroute";
            int minutes = Convert.ToInt16(TextBox1.Text);
            DateTime time = DateTime.Now;
            TimeSpan eta = new TimeSpan(0, minutes, 0);
            Global.ValerieJohnson = time.Add(eta);
            // Global.ValerieJohnson = TextBox1.Text;
