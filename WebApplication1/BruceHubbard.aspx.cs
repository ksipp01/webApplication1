...
{
    public partial class BruceHubbard : System.Web.UI.Page
    {
        private string name;
        ...
        {
            Global.MDrespond++;
            Global.BruceHubbardStatus = "Enroute";
            int minutes = Convert.ToInt16(TextBox1.Text);
            DateTime time = DateTime.Now;
            TimeSpan eta = new TimeSpan(0, minutes, 0);
            Global.BruceHubbard = time.Add(eta);
            // Global.BruceHubbard = TextBox1.Text;
