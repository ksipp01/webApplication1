...
{
    public partial class GregPeterson : System.Web.UI.Page
    {
        private string name;
        ...
        {
            Global.MDrespond++;
            Global.GregPetersonStatus = "Enroute";
            int minutes = Convert.ToInt16(TextBox1.Text);
            DateTime time = DateTime.Now;
            TimeSpan eta = new TimeSpan(0, minutes, 0);
            Global.GregPeterson = time.Add(eta);
            // Global.GregPeterson = TextBox1.Text;
